  ...
  function handleSearchBar() {
    ...
    let searchProducts = []
      ...
      products.forEach(product => {
        if (search) {
          if (product.name.toLowerCase().includes(search.toLowerCase()) || product.keywords.includes(search.toLowerCase())) {
      ...
      if (searchProducts.length !== 0) {
        productsHTML += displayProducts(searchProducts)
      } else {
        productsHTML += displayProducts(products)
      }
  }
